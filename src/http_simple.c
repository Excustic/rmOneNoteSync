// http_simple.c - Lightweight HTTP client implementation
...
int http_get(const char *url, http_response_t *response) {
  ...
  snprintf(request, sizeof(request),
           "GET %s HTTP/1.1\r\n"
           "Host: %s\r\n"
           "User-Agent: RemarkableSyncClient/1.2\r\n"
           "Connection: close\r\n"
           "\r\n",
           path, host);
 ...
 */
int http_post_file(const char *url, const char *api_key, const char *file_path,
                   const char *virtual_path, const char *doc_id,
